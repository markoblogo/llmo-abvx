...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (result?.ok) {
        setMessage("Check your email for a sign-in link to complete registration!");
      }
    } catch (err: any) {
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        <div className="max-w-md mx-auto">
          <div className="mb-8 text-center">
            <p className="font-mono text-sm text-accent mb-2">// CREATE ACCOUNT</p>
            <h1 className="font-mono text-3xl font-bold mb-2">Register</h1>
            <p className="text-sm text-muted-foreground">Join LLMO Directory and make your content AI-visible</p>
          </div>
